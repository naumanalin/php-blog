...
<?php  if(isset($_SESSION['msg'])){
        ...
        unset($_SESSION['msg']);
 ?>
<div class="alert alert-dismissiable <?= $bs_class ?>">
<?= $message ?>
...
<?php } ?>
        ...
        <ul class="navbar-nav ml-auto">
            ...
            <a class="nav-link dropdown-toggle" href="index.php" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <span class="mr-2 d-none d-lg-inline text-gray-600 small">
            <?php
                if(isset($_SESSION['user_data'])){
